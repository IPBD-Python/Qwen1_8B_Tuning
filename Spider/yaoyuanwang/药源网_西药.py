...
def get_3():
    for i in range(1, 3):
        ...
        for sel_b in sel_B:
            ...
            try:
                Name = web.find_element(By.XPATH, '/html/body/div[6]/div/div[2]/ul/li[contains(text(),"【药品名称】")]').text
            except NoSuchElementException:
                Name =''
            try:
                Component = web.find_element(By.XPATH, '/html/body/div[6]/div/div[2]/ul/li[contains(text(),"【成份】")]').text
            except NoSuchElementException:
                Component = ''
            try:
                Trait = web.find_element(By.XPATH, '/html/body/div[6]/div/div[2]/ul/li[contains(text(),"【性状】")]').text
            except NoSuchElementException:
                Trait = ''
            try:
                Drug_efficacy = web.find_element(By.XPATH, '/html/body/div[6]/div/div[2]/ul/li[contains(text(),"【适应症】")]').text
            except NoSuchElementException:
                Drug_efficacy = ''
...
# 获取第一层数据//*[@id="huayao_mulu_nav"]/a[17]
def get_1():
    # for i in range(17,23):
        sel_A = web.find_element(By.XPATH,f'/html/body/div[5]/div[2]/div[2]/div[2]/a[22]')
        sel_A.click()
        get_2()
